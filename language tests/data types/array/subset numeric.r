...
a = array(1, c(2,2,2,2,2))
a[1,1,1,1,1,1]

#! less dimensions produce error
#!e incorrect number of dimensions
a = array(1, c(2,2,2,2,2))
a[1,1,1]
...
#!t FALSE FALSE FALSE 3 2 2 2 "a" "b" "c" "d" "e" "f"
a = array(1,c(2,2,2), dimnames=list(c("a","b"),c("c","d"), c("e","f")))
attributes(a)$xyz = "haha"
b = a[]
b = attributes(b)
...
#!ttt
a = array(1, c(3,3,3), list(c("a","b","c"), c("c","d","e"), c("f","g","h")))
attributes(a)$xyz = 67
attrs = attributes(a[c(1,2),c(1,2),1]) 
length(attrs) == 2
